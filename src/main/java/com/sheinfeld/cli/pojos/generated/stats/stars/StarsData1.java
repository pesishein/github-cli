...
package com.sheinfeld.cli.pojos.generated.stats.stars;
...
public class StarsData1 {
    ...
    public String toString() {
        ...
        sb.append(StarsData1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StarsData1) == false) {
            return false;
        }
        StarsData1 rhs = ((StarsData1) other);
