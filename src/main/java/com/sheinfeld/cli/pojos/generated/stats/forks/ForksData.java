...
package com.sheinfeld.cli.pojos.generated.stats.forks;
...
public class ForksData {
    ...
    public String toString() {
        ...
        sb.append(ForksData.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ForksData) == false) {
            return false;
        }
        ForksData rhs = ((ForksData) other);
